...
#sample_names[sample_names %in% metadata.df$Sequence_file_ID_clean]
...
# Discard samples with less than 5000 reads. It is a low value as we would expect many of these sample sites to be nearly sterile.
dim(otu.m)
otu.m <- otu.m[,colSums(otu.m) >= 10000]
dim(otu.m)
