...
make_heatmap(myheatmap_matrix = heatmap.m*100, 
             ...
             filename = paste0("Result_figures/DESeq_plots/Sample_DESeq_genus_relative_abundance_within_community_heatmap.pdf"),
...
make_heatmap(myheatmap_matrix = heatmap.m*100, 
             mymetadata = heatmap_metadata.df,
             filename = paste0("Result_figures/DESeq_plots/Sample_DESeq_OTU_relative_abundance_within_community_heatmap.pdf"),
             variables = grep("_Season", discrete_variables, value =T,invert = T),
