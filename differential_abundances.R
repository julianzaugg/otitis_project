...
otu_genus_decontaminated.m <-  as.matrix(read.table("Result_tables/count_tables/Genus_counts_decontaminated.csv", sep =",", header =T, row.names = 1))
...
# otu_genus_rare.m <- otu_genus_rare.m[,colnames(otu_genus_rare.m) %in% as.character(metadata_decontaminated.df$Index)]
otu_decontaminated.m <- otu_decontaminated.m[,colnames(otu_decontaminated.m) %in% as.character(metadata_decontaminated.df$Index)]
...
# otu_genus_rare.m <- otu_genus_rare.m[,rownames(metadata_decontaminated.df)]
